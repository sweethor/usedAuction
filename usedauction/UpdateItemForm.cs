...
namespace usedauction
{
    public partial class UpdateItemForm : Form
    {
        ...
        private async void btn_ok_Click(object sender, System.EventArgs e)
        {
            ...
            MessageBox.Show("수정완료.", "알림", MessageBoxButtons.OK);
            await openfirebase.Update_Item(item_No, txt_name.Text, txt_content.Text, str_img, Int32.Parse(txt_sellprice.Text), Int32.Parse(txt_bid.Text), mode, cate);
            this.Close();
        }
